...
Before installing and using svgeez, you'll want to have Ruby 2.4 (or newer) installed on your computer. There are plenty of ways to go about this, but my preference is [rbenv](https://github.com/sstephenson/rbenv). svgeez is developed using Ruby 2.4.6 and is additionally tested against Ruby 2.5.4 and 2.6.2 using [Travis CI](https://travis-ci.org/jgarber623/svgeez).
